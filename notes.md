...
Basic GenAI doesn't apply logic; it uses statistical methods to arrive at answers.

LLMs don't in their basic form do calculations. When you ask a primitive LLM what is `2+3` equals, it only reports `4` because its read that before enough times.
